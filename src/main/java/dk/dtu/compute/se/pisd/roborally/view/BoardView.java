        ...
        for (int x = 0; x < board.width; x++) {
            for (int y = 0; y < board.height; y++) {
               ...
               if (space.getType() == ElementType.ConveyorBelt) {
                   ...
                   spaceView.addImage("C:\\Users\\aljwa\\Desktop\\checkpoint.png", 0, 0);
               } else if (space.getType() == ElementType.Gear) {
                   spaceView.addImage("C:\\Users\\aljwa\\Desktop\\gear.png",0,0);
               } else if (space.getType() == ElementType.Wall) {
                   spaceView.addImage("C:\\Users\\aljwa\\Desktop\\wall.png",0,0);
               }
            }
        }
